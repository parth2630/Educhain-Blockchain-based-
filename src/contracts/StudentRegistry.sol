...
contract StudentRegistry {
    ...
    function deleteStudent(address studentAddress) public onlyAdmin {
        require(isStudent[studentAddress], "Student not registered");
        
        Student memory student = students[studentAddress];
        isUsernameTaken[student.username] = false;
        isRollNoTaken[student.rollNo] = false;
